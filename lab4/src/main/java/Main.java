...
//        Matching<Element<Resident>, Element<Hospital>> matching = new Matching<>();
//        matching.add(new Partition<>(residents.get(0), hospitals.get(1)));
//        matching.add(new Partition<>(residents.get(1), hospitals.get(2)));
//        matching.add(new Partition<>(residents.get(2), hospitals.get(1)));
//        matching.add(new Partition<>(residents.get(3), hospitals.get(0)));
